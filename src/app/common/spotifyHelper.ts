...
export function SpotifyArtistaParaArtista(spotifyArtista: SpotifyApi.ArtistObjectFull):
IArtista{
    return{
...
export function SpotifyTrackParaMusica(spotifyTrack: SpotifyApi.TrackObjectFull):
IMusica{
